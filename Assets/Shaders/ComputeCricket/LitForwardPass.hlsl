...
StructuredBuffer<Cricket> cricketsBuffer;
...
Varyings LitPassVertex(Attributes input)
{
    ...
    Cricket cricket = cricketsBuffer[input.instanceID];

    float4x4 mat = create_matrix(cricket.position, float3(0, 1, 0), float3(1.0, 0.0, 0.0));
